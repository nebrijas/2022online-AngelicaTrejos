...
Se guardará la información de la misma forma como lo hicimos antes pero agregando la abreviatura de Colombia "df_co". Esta cambiará según la información que necesite. también se puede aprovechar para incluir una función de estilo que le dé una mejor imagen a la tabla.
